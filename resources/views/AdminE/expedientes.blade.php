...
<!-- Se extiende de la plantilla base -->
                ...
                <form action="{{ url('/expedientes/update') }}" method="POST" class="popup-content">
                    ...
                    @foreach ($estados as $estado_opcion)
                        <div class="popup-color">
                            <span class="popupCircle color-circle" style="background-color:  {{ $estado_opcion->colors }}"
                                onclick="setColor(event)" data-color="{{ $estado_opcion->colors }}"
                                data-id="{{ $estado_opcion->id }}"></span>
                    ...
                    @foreach ($expedientes as $expediente)
                        ...
                        <tr>
                            ...
                            <td colspan="2" class="estados">
                                ...
                                <span class="circle" data-id="{{ optional($expediente)->id }}"
                                    data-id_color="{{ optional($expediente->estat_expedient)->id }}"
                                    style="background-color: {{ optional($expediente->estat_expedient)->colors ?? '#ccc' }}"
                                    onclick="mostrarPopup(event)"></span>
                            ...
                            <td>
                                <form action="{{ route('mostrarcartasllamadas', ['id' => $expediente->id]) }}"
                                    method="GET">
